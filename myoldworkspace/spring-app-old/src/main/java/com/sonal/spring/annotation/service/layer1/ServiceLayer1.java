package com.sonal.spring.annotation.service.layer1;
...
import com.sonal.spring.annotation.main.RequestVO;
import com.sonal.spring.annotation.service.layer2.ServiceLayer2;
...
public class ServiceLayer1 {
	...
	public void doSomething(String name, RequestVO requestVO) throws IOException{		
		serviceLayer2.doSomething();		
