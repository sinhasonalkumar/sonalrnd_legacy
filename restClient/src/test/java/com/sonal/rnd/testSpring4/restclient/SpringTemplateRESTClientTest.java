...
public class SpringTemplateRESTClientTest {

	@Autowired
	private SpringTemplateRESTClient springTemplateRESTClient;
	
	@Test
	public void testGetCall() throws Exception{
		springTemplateRESTClient.getCall();
	}
	
	@Test
	public void testPostCall() throws Exception{
		springTemplateRESTClient.postCall();
	}
}
