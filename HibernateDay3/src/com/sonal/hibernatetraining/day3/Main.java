package com.sonal.hibernatetraining.day3;
...
import com.sonal.hibernatetraining.day3.perstistence.Student;
import com.sonal.hibernatetraining.day3.util.SessionFactoryUtil;
...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Eh Caching exammle !!");
		SessionFactory sessionFactory = SessionFactoryUtil.getInstance();		
